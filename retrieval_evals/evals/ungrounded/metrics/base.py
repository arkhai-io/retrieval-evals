"""Base class for ungrounded metrics."""
...
class Metric(ABC):
    """Base class for all ungrounded metrics."""
    ...
    def load_data(self, json_path: Path | str) -> list[QAPair]:
    ...
    def evaluate(self, data: Path | str | list[QAPair]) -> list[EvalResult]:
